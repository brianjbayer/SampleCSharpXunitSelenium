## Development of SampleCSharpXunitSelenium
...
```bash
./SampleCSharpXunitSelenium/script/dockercomposerun -d
```
...
```bash
./SampleCSharpXunitSelenium/script/dockercomposerun -do
```
...
2. Run your development environment image in the docker compose
   ...
   ```bash
   BROWSERTESTS_IMAGE=browsertests-dev ./SampleCSharpXunitSelenium/script/dockercomposerun -d
   ```
...
```bash
BROWSERTESTS_SRC=${PWD} BROWSERTESTS_IMAGE=browsertests-dev ./SampleCSharpXunitSelenium/script/dockercomposerun -d
```
